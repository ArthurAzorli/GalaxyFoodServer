...
public record OutClientDTO (UUID id, String cpf, String name, String email, LocalDate birthDate, List<Integer> image, List<Address> addresses, List<Phone> phones){
}
